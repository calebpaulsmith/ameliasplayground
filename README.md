...
built as an installable PWA. Three games — **Aprender** (learn), **Atrapar
estrellas** (catch stars) and **Torre de cohetes** (rocket tower) — plus a
prize shelf, star rewards and adaptive difficulty. Works offline once loaded.
